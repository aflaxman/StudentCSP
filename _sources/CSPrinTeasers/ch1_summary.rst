...
- **Program** - A program is a set of instructions that a computer can understand, and can use to accomplish some goal.  This is sometimes called **code**.  
...
- **Variable** -  A variable is a name associated with computer memory that can hold a value. One example of a variable is the score in a game.
